    ...
    <section class="py-8">
        <div class="container px-4 mx-auto">
            <div class="py-4 bg-white rounded">
                <form action="{{ route('admin.users_topi.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="flex px-6 pb-4 border-b">
                        <h3 class="text-xl font-bold">ユーザー登録とユーザー特別トピ登録</h3>
                        <div class="ml-auto">
                            <button type="submit"
                    ...
                    <div class="pt-4 px-6">
                        ...
                        <div class="mb-6">
                            <label class="block text-sm font-medium mb-2" for="password">パスワード（フルーツの名前・英語）</label>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="flex items-end">
                                <img id="previewImage" src="/img/admin/noimage.jpg" data-noimage="/images/admin/noimage.jpg"
                        ...
                        <div class="mb-6">
                            ...
                            <input id="kokopoi_question" class="block w-full px-4 py-3 mb-2 text-sm bg-white border rounded"
                                type="text" name="kokopoi_question" value="{{ old('kokopoi_question') }}">
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="kokopoi_answer" class="block w-full px-4 py-3 mb-2 text-sm bg-white border rounded" name="kokopoi_answer"
                                rows="5">{{ old('kokopoi_answer') }}</textarea>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <input id="emb_img_title" class="block w-full px-4 py-3 mb-2 text-sm bg-white border rounded"
                                type="text" name="emb_img_title" value="{{ old('emb_img_title') }}">
                        </div>

                        <div class="mb-6">
                            <label class="block text-sm font-medium mb-2" for="emb_img">エンべ画像</label>
                            <div class="flex items-end">
                                <img id="previewImage" src="/img/admin/noimage.jpg"
