                    ...
                    <div class="pt-4 px-6">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="flex items-end">
                                <img id="previewImage" src="{{ asset('storage/' . $topi->hl_image) }}"
                        ...
                        <div class="mb-6">
                            ...
                            <div class="flex items-end">
                                <img id="previewImage" src="{{ asset('storage/' . $topi->main_image) }}"
                        ...
                        <div class="mb-6">
                            ...
                            <div class="flex items-end">
                                <img id="previewImage" src="{{ asset('storage/' . $topi->emb_img) }}"
