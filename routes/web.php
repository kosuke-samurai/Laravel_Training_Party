...
//管理情報の登録
Route::get('/admin/resister', [ResisterAdminController::class, 'create'])->name('admin.resister')->middleware('auth:administrators');
Route::post('/admin/resister', [ResisterAdminController::class, 'store'])->name('admin.resister.store')->middleware('auth:administrators');
